...
- name: www2
  ...
  EXPECT_THROW_WITH_MESSAGE(
      TestConfigImpl(parseRouteConfigurationFromYaml(yaml), factory_context_, true), EnvoyException,
      "Specify only one of prefix_rewrite, regex_rewrite or pattern_rewrite");
}
...
virtual_hosts:
  - name: path_pattern
    ...
    routes:
      ...
      - match:
          path_template_match: "/boo/{go}/{fly}/{bat}"
          case_sensitive: false
        route: { cluster: path-pattern-cluster-two}
      - match:
          path_template_match: "/foo/boo/{go}/{fly}/{bat}/{sno}"
          case_sensitive: false
...
virtual_hosts:
  - name: path_pattern
    ...
    routes:
      - match:
          path_template_match: "/rest/{one}/{two}"
          case_sensitive: false
        route:
          cluster: "path-pattern-cluster-one"
          pattern_rewrite: "/rest/{two}/{one}"
  )EOF";
  NiceMock<Envoy::StreamInfo::MockStreamInfo> stream_info;
...
virtual_hosts:
  ...
  EXPECT_THROW_WITH_MESSAGE(
      TestConfigImpl config(parseRouteConfigurationFromYaml(yaml), factory_context_, true),
      EnvoyException, "path_template_match /rest/{one/{two} is invalid");
}
...
virtual_hosts:
  - name: path_pattern
    ...
    routes:
      - match:
        ...
        route:
          cluster: "path-pattern-cluster-one"
          pattern_rewrite: "/rest/{one}/{two}/{missing}"
  )EOF";
  NiceMock<Envoy::StreamInfo::MockStreamInfo> stream_info;
  factory_context_.cluster_manager_.initializeClusters({"path-pattern-cluster-one"}, {});
  ...
  EXPECT_THROW_WITH_MESSAGE(
      TestConfigImpl config(parseRouteConfigurationFromYaml(yaml), factory_context_, true),
      EnvoyException,
      "mismatch between path_template_match /rest/{one}/{two} and pattern_rewrite "
...
virtual_hosts:
  - name: path_pattern
    ...
    routes:
      - match:
          path_template_match: "/rest/{on==e}/{two}"
          case_sensitive: false
        route:
          cluster: "path-pattern-cluster-one"
          pattern_rewrite: "/rest/{one}/{two}/{missing}"
  ...
  EXPECT_THROW_WITH_MESSAGE(
      TestConfigImpl config(parseRouteConfigurationFromYaml(yaml), factory_context_, true),
      EnvoyException, "path_template_match /rest/{on==e}/{two} is invalid");
}
...
virtual_hosts:
  - name: path_pattern
    ...
    routes:
      - match:
          path_template_match: "/rest/{one=*}/{last=**}"
          case_sensitive: false
        route:
          cluster: "path-pattern-cluster-one"
          pattern_rewrite: "/{last}"
  )EOF";
  NiceMock<Envoy::StreamInfo::MockStreamInfo> stream_info;
  factory_context_.cluster_manager_.initializeClusters({"path-pattern-cluster-one"}, {});
...
virtual_hosts:
  - name: path_pattern
    ...
    routes:
      - match:
          path_template_match: "/rest/{one}/{middle=videos/*}/end"
          case_sensitive: false
        route:
          cluster: "path-pattern-cluster-one"
          pattern_rewrite: "/{middle}"
  )EOF";
  NiceMock<Envoy::StreamInfo::MockStreamInfo> stream_info;
  factory_context_.cluster_manager_.initializeClusters({"path-pattern-cluster-one"}, {});
...
virtual_hosts:
  - name: path_pattern
    ...
    routes:
      - match:
          path_template_match: "/rest/{one}/{One}/end"
          case_sensitive: false
        route:
          cluster: "path-pattern-cluster-one"
          pattern_rewrite: "/{One}/{one}"
  )EOF";
  NiceMock<Envoy::StreamInfo::MockStreamInfo> stream_info;
  factory_context_.cluster_manager_.initializeClusters({"path-pattern-cluster-one"}, {});
...
virtual_hosts:
  - name: path_pattern
    ...
    routes:
      - match:
          path_template_match: "/rest/{one}/{two}/{three}/{four}/{five}/{six}"
          case_sensitive: false
        route:
          cluster: "path-pattern-cluster-one"
  )EOF";
  ...
  EXPECT_THROW_WITH_MESSAGE(
      TestConfigImpl config(parseRouteConfigurationFromYaml(yaml), factory_context_, true),
      EnvoyException,
      "path_template_match /rest/{one}/{two}/{three}/{four}/{five}/{six} is invalid");
}
